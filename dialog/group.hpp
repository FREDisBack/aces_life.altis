...
class Life_Browse_Group_Diag {
	...
	class controls {
		...
		class Title : Life_RscTitle {
			colorBackground[] = {0, 0, 0, 0};
			idc = -1;
			text = "Группа в - отображение групп";
			x = 0.1;
			y = 0.2;
			w = 0.6;
			h = (1 / 25);
...
class Life_Create_Group_Diag {
	...
	class controls {
		...
		class InfoMsg : Life_RscStructuredText
		{
			idc = -1;
			sizeEx = 0.020;
			text = "<t align='center'>Это стоит ничего, чтобы создать группу.</t>";
			x = 0.1;
			y = 0.25;
			w = 0.5; h = (1 / 24);
		};
...
class Life_Group_Prompt
{
	...
	class controls 
	{
		class InfoMsg : Life_RscStructuredText
		{
			idc = -1;
			sizeEx = 0.020;
			text = "<t align='center'><t size='.8px'>Вы в настоящее время не являются группой. Что вы хотите сделать?</t></t>";
			x = 0.287;
			y = 0.2 + (11 / 250);
			w = 0.5; h = 0.12;
		};
