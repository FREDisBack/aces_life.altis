...
class marketView
{
	...
	class controlsBackground
	{
		...
		{
			idc = 1100;
			text = "<t size='1.2' align='center'>Altis Рынок</t>"; //--- ToDo: Localize;
		...
		{
			idc = 1101;
			text = "<t align='center'>Развитие</t>"; //--- ToDo: Localize;
			x = 17 * GUI_GRID_W + GUI_GRID_X;
		...
		{
			idc = 1002;
			text = "С момента рестарта"; //--- ToDo: Localize;
		...
		{
			idc = 1003;
			text = "Актуальные рыночные цены"; //--- ToDo: Localize;
			x = 20.5 * GUI_GRID_W + GUI_GRID_X;
			y = 13.5 * GUI_GRID_H + GUI_GRID_Y;
			w = 13 * GUI_GRID_W;
			h = 1 * GUI_GRID_H;
