...
switch (_this select 0) do
{
	...
	case "sourceUp":
	{
		...
		switch (CLAY_RadioSrc) do
		{
			...
			case 5:
			{
				ctrlSetText [611, "Польз."];
				CLAY_RadioPlayList = CLAY_RadioCustomMusic;

				If (count CLAY_RadioCustomMusic == 0) Then
				{
					Hint "Не найдено пользовательских плейлистов!\n\nДля создания нажмите 'Плейлист' в плеере.";
	...
	case "dCol":
	{
		...
		{
			[] execVM "CLAY_CarRadio\scripts\display.sqf";
			ctrlSetText [614, "Изм. цвета"];
		}
		Else
		{
			private ["_color"];
