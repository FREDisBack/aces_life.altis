...
switch (_var) do
{
	...
	case "life_inv_rabbit": {("icons\items\burger.paa")};
	...
	case "life_inv_water": {("icons\items\apfelsaft.paa")};
	...
	case "life_inv_zinnu": {("icons\items\zinnu.paa")};
	case "life_inv_zuckeru": {("icons\items\sugarcane.paa")};
	case "life_inv_getreideip": {("icons\items\whiskey.paa")};
	case "life_inv_tabakip": {("icons\items\zigarre.paa")};
	case "life_inv_zuckerip": {("icons\items\rum.paa")};
	case "life_inv_eisenp": {("icons\items\silver.paa")};
	case "life_inv_getreidep": {("icons\items\mehl.paa")};
	case "life_inv_holzp": {("icons\items\charcoal.paa")};
	case "life_inv_hopfenp": {("icons\items\beer.paa")};
	case "life_inv_schwefelp": {("icons\items\schwefelp.paa")};
	case "life_inv_silberp": {("icons\items\silver.paa")};
	case "life_inv_tabakp": {("icons\items\zigarette.paa")};
	case "life_inv_traubenp": {("icons\items\wein.paa")};
	case "life_inv_zinnp": {("icons\items\zinn.paa")};
	case "life_inv_zuckerp": {("icons\items\sugar.paa")};
	...
	case "life_inv_pkugel": {("icons\items\bomb.paa")};
    ...
    case "life_inv_uwsl": {("icons\items\blastingcharge.paa")};
	case "life_inv_pylone": {("icons\pylon.paa")};
	case "life_inv_licht": {("icons\ico_storageBig.paa")};
    case "life_inv_tablet": {("icons\tablet.paa")};
	case "life_inv_barriere": {("icons\absperrung.paa")};
};