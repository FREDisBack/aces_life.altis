...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "aan": {_var = "license_civ_aan"}; //AAN  
			...
			case "adf": {_var = "license_civ_adf"};
			case "krem": {_var = "license_civ_krem"};
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_civ_aan": {_var = "aan"}; //AAN
			...
			case "license_civ_adf": {_var = "adf"};
			case "license_civ_krem": {_var = "krem"};
