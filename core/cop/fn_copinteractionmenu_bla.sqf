...
if(!((player distance (getMarkerPos "jail_release") < 100) OR (player distance (getMarkerPos "police_hq_1") < 50) OR (player distance (getMarkerPos "cop_jail_spawn_1") < 50) OR (player distance (getMarkerPos "police_hq_2") < 50) OR (player distance (getMarkerPos "cop_spawn_3") < 50) OR (player distance (getMarkerPos "cop_spawn_5") < 50))) then 
{
	_Btn6 ctrlEnable false;
};
