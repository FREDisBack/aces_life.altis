...
if(profileName != (_this select 1) && (_this select 1) != "") exitWith {
	//hint format["Ваш старый ник %1",_this select 1];
	[format["За вашим ID закреплён другой ник, укажите свой старый ник в профиле игры!<br/><br/>Ваш старый ник <t color='#b20303'>%1</t><br/><br/>Если у вас проблемы с изменением ника - обратитесь к Админу <t color='#665bff'>Delfin</t>",
	_this select 1],
