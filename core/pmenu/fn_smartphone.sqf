...
*/
private["_display","_units","_type","_data","_rowData","_msg","_isPhone"];
...
switch(_type) do
{
	case 0:
	{
		...
		[[getPlayerUID player, player],"TON_fnc_msgRequest",false,false] spawn life_fnc_MP
		ctrlEnable[887892,false];
	};
	case 1:
	{
	...
	case 4:
	{
		...
		ctrlSetText[88886, format["Сообщение для: %1 %1",name life_smartphoneTarget]];
