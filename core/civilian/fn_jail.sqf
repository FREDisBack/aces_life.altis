...
titleText["Вы были отправлены в тюрьму! Если вы попатаетесь релогнуться ваше время увеличися,если сбежите методом бага вас забанят!","PLAIN"];
...
player forceAddUniform "jamie_poloorangeblack";
