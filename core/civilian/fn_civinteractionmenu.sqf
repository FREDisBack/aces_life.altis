...
//связанные не могу ничего нажимать
if(player getVariable "restrained") exitWith {closeDialog 0;}; //Bad target

if(!isPlayer _curTarget) exitWith {hint "Цель на игрока не выбрана"; closeDialog 0; };
//if(!license_civ_rebel) exitWith {hint "Вы не повстанец"; closeDialog 0;}; //Bad side check?
/*
