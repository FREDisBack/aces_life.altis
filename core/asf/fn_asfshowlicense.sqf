...
{
	hint "Вы не являетесь военнослужащим!";
};
...
_message = format["<img size='10' color='#FFFFFF' image='textures\ASF\rank.jpg'/><br/><br/><t size='2.5'>%1</t><br/><t size='1.8'>%2</t><br/><br/><t color='#336699' size='1.6'>Армия Алтиса</t>", name player, _rang];
