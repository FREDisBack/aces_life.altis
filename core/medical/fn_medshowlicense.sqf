...
switch ( _coplevel ) do {
	case 1: { _rang = "Санитар"; };
	case 2: { _rang = "Интерн"; };
	case 3: { _rang = "Терапевт"; };
	case 4: { _rang = "Начальник МЧС"; };
};

_message = format["<img size='10' color='#FFFFFF' image='textures\medic\marke.paa'/><br/><br/><t size='2.5'>%1</t><br/><t size='1.8'>%2</t><br/><br/><t color='#d41515' size='1.6'>Департамент МЧС</t>", name player, _rang];
