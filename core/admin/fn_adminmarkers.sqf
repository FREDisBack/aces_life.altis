...
if(life_markers) then {
	...
	[[0,format["Админ %1 включил маркер",profileName]],"life_fnc_broadcast",nil,false] spawn life_fnc_MP;
...
FinishedLoop = true;
	...
	[[0,format["Админ %1 выключил маркер",profileName]],"life_fnc_broadcast",nil,false] spawn life_fnc_MP;
