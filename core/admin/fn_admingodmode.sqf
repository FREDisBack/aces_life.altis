...
if(life_god) then {
	...
	[[0,format["Админ %1 выкл год-мод",profileName]],"life_fnc_broadcast",nil,false] spawn life_fnc_MP;
	player allowDamage true;
} else {
	life_god = true;
	titleText ["God mode enabled","PLAIN"]; titleFadeOut 2;
	[[0,format["Админ %1 вкл год-мод",profileName]],"life_fnc_broadcast",nil,false] spawn life_fnc_MP;
