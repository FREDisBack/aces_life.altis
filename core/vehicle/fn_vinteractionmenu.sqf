...
*/
private["_display","_curTarget","_bRepair","_bRegister","_bSearch","_bPullOut","_bImpound","_bTowning","_bFlip","_bPullOutCiv"];
if(!dialog) then {
...
_display = findDisplay 37400;
	...
	_bPullOutCiv = _display displayCtrl 2409;
...
if(playerSide == civilian) then {
	...
	_bPullOutCiv ctrlSetTooltip localize "STR_vInAct_PullOut";
	_bPullOutCiv buttonSetAction "closeDialog 0; [life_vInact_curTarget] spawn life_fnc_pulloutAction;";
	if(count crew _curTarget == 0) then {_bPullOutCiv ctrlEnable false;};
	
	if((typeOf _curTarget == "RDS_Zetor6945_Base") && {_curTarget in life_vehicles}) then {
